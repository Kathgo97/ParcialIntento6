...
public class Fragment_ContactClick extends Fragment implements Serializable {
    ImageView Profile;
    TextView Name;
    RadioButton Number;
    TextView Email;
    ...
    private static final int PERMISSIONS_REQUEST_PHONE_CALL = 105;
    Contact C;

    public Fragment_ContactClick() {
            ...
            Share.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(radioButtonID!=-1) {
                        ...
                        Uri imageUri;
                        if (path == "")
                            imageUri = Uri.parse("android.resource://com.example.kaherine.parcialintento6/drawable/ic_account_circle");
                        else
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.contact_click, container, false);
    }
    @Override
